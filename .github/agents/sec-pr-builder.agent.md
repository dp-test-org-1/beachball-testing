...
## 4. Verify, Build & Test
* **Compile all internal packages:** Run `pnpm --filter "./packages/**" build`
* **Verify the test app:** Run `pnpm --filter <test-app-name> build` and `pnpm --filter <test-app-name> test`.
